...
const HeaderWrapper = newStyled.div`
  ...
  padding: 16px 24px;
`;
const BasketWrapper = newStyled.div`
  position: relative;
`;
const BasketCountTextWrapper = newStyled.div`
  width: 19px;
  height: 19px;
  position: absolute;
  right: 0;
...
const IMAGE_PATH = Object.freeze({
  ...
  SHOPPIN_CART_REMOVE: "./shopping-cart-remove.svg",
...
const Header$1 = ({ basketCount }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(HeaderWrapper, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(BasketWrapper, { children: [
      basketCount !== 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(BasketCountTextWrapper, { children: basketCount }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: IMAGE_PATH.SHOPPING_BASKET })
    ] })
  ] });
};
...
const ProductCardPrice = newStyled.div`
  ...
  font-weight: 500;
`;
const CartToggleButtonWrapper = newStyled.div`
  display: flex;
  background-color: ${({ isInBascket }) => isInBascket ? "#EAEAEA" : "#000000"};
  border-radius: 4px;
  padding: 4px 8px;
  gap: 4px;
  cursor: pointer;
`;
const CartToggleButtonText = newStyled.div`
  color: ${({ isInBascket }) => isInBascket ? "#000000" : "#ffffff"};
  background-color: 
  font-size: 12px;
  font-weight: 600;
`;
const MAX_BASKET_COUNT = 50;
const ERROR_MSG = {
...
const deleteCartItem = async (basketId) => {
  return await apiRequest(`${END_POINT.CART}/${basketId}`, {
    method: "DELETE"
  });
};
...
const CartToggleButton = ({
  ...
  const imageSrc = isInBascket ? IMAGE_PATH.SHOPPIN_CART_REMOVE : IMAGE_PATH.SHOPPIN_CART_ADD;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    CartToggleButtonWrapper,
    {
      isInBascket,
      onClick: () => handleCartToggleButton({
        isInBascket,
        productId: id2,
        basketId,
        isNotBasketCountMAX,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imageSrc, alt: "shopping_cart" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartToggleButtonText, { isInBascket, children: isInBascket ? "빼기" : "담기" })
      ]
    }
  );
};
const ProductCard = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductCardWrapper, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductCardDetailWrapper, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartToggleButton, { id: id2, isInBascket, basketId, isNotBasketCountMAX, setError })
    ] })
  ] });
};
...
const SelectDropdownContainer = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectDropdown, { title: sort, options: SORT, onSelect: (value) => setSort(value) })
    ] })
  ] });
};
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header$1, { basketCount: basketProductsIds.length }),
